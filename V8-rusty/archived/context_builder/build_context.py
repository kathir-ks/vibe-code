...
def build_context(file_path: str, model) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        logging.info(f"Sleeping for {delay:.2f} seconds bedore processing {file_path}")
        time.sleep(delay)
...
def save_analysis(analysis_result: Dict[str, Any], output_dir: str, file_path: str) -> None:
    ...
    output_file = os.path.join(output_path, f"{file_name}.context")
